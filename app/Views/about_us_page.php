...
<div class="col-8 col-md-8 offset-md-2 mb-5 mt-5">
	<div class="row">
		<div class="text-center container">
			<h1 class="pb-5">Yosi Josef Kats</h1>
			<p class="col-xl-8 mx-auto pb-5 h4">Some text that describes me lorem ipsum ipsum lorem.</p>
			<p class="col-xl-8 mx-auto pb-5 h4">yosi@123code.co</p>
			<p></p>
		</div>
	</div>
</div>
